...
发布名：`@firefly0621/dsh-skill-superpowers`（版本跟随 harness 家族，当前为 `0.1.0-rc.7`）。本 fork 包的源码真源：[github.com/oThTJx/dsh-skill-superpowers](https://github.com/oThTJx/dsh-skill-superpowers)。本包为显式 opt-in，不属于官方 main 的 `dsh-base` 组合。
